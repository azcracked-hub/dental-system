<div>
    ...
    <div class="inline-flex bg-white rounded-full p-1 shadow-sm mb-8 border border-gray-100">
        <button
            ...
            @class([
                'px-5 py-2 text-sm font-medium rounded-full transition flex items-center gap-2',
                'bg-yellow-500 text-white' => $activeTab === 'today',
                'text-gray-600 hover:text-gray-800' => $activeTab !== 'today',
            ])
        >
        ...
        <button
            ...
            @class([
                'px-5 py-2 text-sm font-medium rounded-full transition flex items-center gap-2',
                'bg-yellow-500 text-white' => $activeTab === 'all',
                'text-gray-600 hover:text-gray-800' => $activeTab !== 'all',
            ])
        >
        ...
        <button
            wire:click="setActiveTab('patients')"
            @class([
                'px-5 py-2 text-sm font-medium rounded-full transition flex items-center gap-2',
                'bg-yellow-500 text-white' => $activeTab === 'patients',
                'text-gray-600 hover:text-gray-800' => $activeTab !== 'patients',
            ])
        >
        ...
        <button
            ...
            @class([
                ...
                'text-gray-600 hover:text-gray-800' => $activeTab !== 'billing',
            ])
        >
                    ...
                    @foreach($todayAppointments as $apt)
                        <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-100 flex justify-between items-center">
                            ...
                            <div class="text-right">
                                <p class="text-gray-800 font-semibold"><x-clinic-time :time="$apt->time" /></p>
        ...
        <div>
            <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-2 mb-6 flex items-center">
                ...
                <input
                    ...
                    class="w-full border-none focus:ring-0 text-sm ml-2 text-gray-600 placeholder-gray-400"
                >
            </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    ...
                                    @elseif($apt->status === 'canceled')
                                        <span class="bg-red-100 text-red-800 text-xs font-medium px-2.5 py-0.5 rounded-full border border-red-200">canceled</span>
                                    @else
                                        <span class="bg-gray-100 text-gray-800 text-xs font-medium px-2.5 py-0.5 rounded-full border border-gray-200">{{ $apt->status }}</span>
                                    @endif
                                </div>
